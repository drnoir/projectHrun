...
if (typeof gdjs.evtsExt__Inventories__RemoveItem !== "undefined") {
  gdjs.evtsExt__Inventories__RemoveItem.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__Inventories__RemoveItem = {};


gdjs.evtsExt__Inventories__RemoveItem.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__Inventories__RemoveItem.func = function(runtimeScene, InventoryName, ItemName, parentEventsFunctionContext) {
...
gdjs.evtsExt__Inventories__RemoveItem.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__Inventories__RemoveItem.registeredGdjsCallbacks = [];