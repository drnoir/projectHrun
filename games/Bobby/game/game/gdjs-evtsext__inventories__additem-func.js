...
if (typeof gdjs.evtsExt__Inventories__AddItem !== "undefined") {
  gdjs.evtsExt__Inventories__AddItem.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__Inventories__AddItem = {};


gdjs.evtsExt__Inventories__AddItem.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__Inventories__AddItem.func = function(runtimeScene, InventoryName, ItemName, parentEventsFunctionContext) {
...
gdjs.evtsExt__Inventories__AddItem.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__Inventories__AddItem.registeredGdjsCallbacks = [];