...
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox = class TwoChoicesDialogBox extends gdjs.CustomRuntimeObject2D {
  constructor(parentInstanceContainer, objectData) {
    ...
    this._objectData.ActiveButtonById = objectData.content.ActiveButtonById !== undefined ? objectData.content.ActiveButtonById : Number("0") || 0;
  ...
  updateFromObjectData(oldObjectData, newObjectData) {
    ...
    if (oldObjectData.content.ActiveButtonById !== newObjectData.content.ActiveButtonById)
      this._objectData.ActiveButtonById = newObjectData.content.ActiveButtonById;
  ...
  _getActiveButtonById() {
    return this._objectData.ActiveButtonById !== undefined ? this._objectData.ActiveButtonById : Number("0") || 0;
  }
  _setActiveButtonById(newValue) {
    this._objectData.ActiveButtonById = newValue;
  }
  _getEnableEscape() {
...
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(17133860);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(17137940);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects1, gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(17141564);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects1, gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(17145188);
}
}
}
if (isConditionTrue_0) {
...
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.eventsList1(runtimeScene, eventsFunctionContext);
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects1.length = 0;
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects2.length = 0;
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDObjectObjects3.length = 0;
gdjs.evtsExt__TwoChoicesDialogBoxes__TwoChoicesDialogBox.TwoChoicesDialogBox.prototype.doStepPostEventsContext.GDNoButtonObjects1.length = 0;
...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0]._getActiveButtonById(); }}}
